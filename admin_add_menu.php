...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `yummy_dishes` (name, price, image) VALUES ('$name','$price','$img_name')";
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <a href="/Yummy/bannerpage.php" class="logo d-flex align-items-center me-auto me-lg-0">
      ...
      <a class="btn-book-a-table ml-5" href="signout.php">Signout</a>
...
<form method="post" action="" class="container" enctype="multipart/form-data" onsubmit="return validateForm()">
    <div class="my-5">
        <label for="exampleInputEmail1" class="form-label">Dish Name:</label>
        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" autocomplete="no" name="name" required>
    </div>
    <div class="my-5">
        <label for="exampleInputPassword1" class="form-label">Dish Price:</label>
        <input type="text" class="form-control" id="exampleInputPassword1" autocomplete="on" name="price" required>
    </div>
    <div class="my-5">
        <label for="exampleInputPassword1" class="form-label">Dish Image:</label>
        <input type="file" class="form-control" id="exampleInputPassword1" autocomplete="no" name="image" required>
    </div>
