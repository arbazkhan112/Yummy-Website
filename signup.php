...
if (isset($_POST["btn_submit"])) {
  ...
  if (empty($name) || empty($email) || empty($password)) {
    ...
    $query = "INSERT INTO `tbl_yummy`(`name`, `email`, `password`) VALUES ('$name','$email','$password')";
...
<!-- Add this PHP code to display the error message
<?php
if (!empty($error)) {
...
<script>
  function validateForm() {
    ...
    // Password format validation (for example, minimum length of 8 characters)
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <a href="/Yummy/bannerpage.php" class="logo d-flex align-items-center me-auto me-lg-0">
      ...
      <div class="d-flex">
      <a class="btn-book-a-table" href="/Yummy/signin.php">Signin</a>
  ...
  <div class="wrapper fadeInDown my-5">
    <div id="formContent">
      ...
      <form action="" method="POST" name="signupForm" onsubmit="return validateForm()">
        <h3 class="my-3">ADMIN SIGNUP</h3>
        <input type="text" name="userName" id="login" class="fadeIn second" placeholder="Name">
        <input type="text" name="userEmail" id="login" class="fadeIn second"  placeholder="Email">
        <input type="text" name="userPassword" id="password" class="fadeIn third"  placeholder="Password">
        <!-- <input type="submit" name="btn_submit" onclick="return fun()" class="fadeIn fourth my-5" value="Sign up"> -->
        <input type="submit" name="btn_submit" class="fadeIn fourth my-5" value="Sign up">
      </form>
